...
class DataPortalMng():
    ...
    def processResponse(self, response):
        ...
        for dp in data.keys():
            ...
            portal = DataPortal()
            try:
                portal.createDataPortal(str(id_name),str(name),str(title),str(url),str(author),str(publisher) ,str(issued) ,
                                        str(publisher_classification),str(description),str(tags),str(license_id),str(license_url),
                                        str(place),str(location),str(country),str(language),str(status),str(metadatacreated),
                                        str(generator),str(api_endpoint),str(api_type),str(full_metadata_download),str(description_html),
